...
# ╔═╡ 3bc29ded-985e-4268-b726-ab5b4f2a5e75
begin
	using DataFrames
	using CSV
end

# ╔═╡ 41b6ebc0-2cef-42f2-9c49-5a15b7b0a568
using Plots  # This will install plots


# ╔═╡ 8c955952-eb37-4c2c-b72f-889ea41ae5ef
using PlutoUI


# ╔═╡ edc501cf-a3a4-48ba-abf1-d3a93939d749
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 35a5f208-7fdd-4178-9cf6-ac20fdda280e
df.Country_code === df[!, "Country_code"]


# ╔═╡ 692f399e-1e07-4c09-8af8-d97b0df22314
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ 02b43ec2-d841-4097-8ae7-c90671d9fd39
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ 1d1bcbb8-c3bf-4ad9-b514-1a87d15a8a13
dates = sg_data[!, "Date_reported"]


# ╔═╡ d36ef074-ca48-4eb7-8f97-03ba46dbd2c3
cumulative_cases = sg_data[!, "Cumulative_cases"]


# ╔═╡ c4dcddd4-fd86-4c89-9f08-79b126e7f0a7
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ 00b65d1e-fda9-4eac-a49b-87fcc73bccec
...
# ╔═╡ 1c282a27-dd7d-4957-ae38-0577110839b4
@bind slider_value Slider(0:10:1000)


# ╔═╡ c031d52a-435b-40f8-9bdb-3f56ae9884db
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 8cd66993-e1e8-4282-98a1-261dcab364be
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ 2581d195-3ec1-4240-a454-80c737998bf3
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ dec3d33a-9178-4571-a266-e33ec28349ad
